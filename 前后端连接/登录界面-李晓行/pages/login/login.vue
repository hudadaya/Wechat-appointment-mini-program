        ...
        <form @submit="login" class="login-form">
          ...
          <view class="input-group password-group">
              ...
              <!-- <view class="password-toggle" @click="togglePassword">
                    <image :src="showPassword ? require('@/static/login/open.png') : require('@/static/login/close.png')" class="toggle-icon" />
                  </view> -->
            </view>
		  <!-- 隐私协议 -->
		 <!-- <view class="privacy-agreement">
			  <view class="checkbox" @click="toggleAgreement">
				<view :class="{ checked: agreed }"></view>
			  </view>
			  <text class="agreement-text">
                <text>点击阅读并同意 </text>
				<navigator url="/privacy" class="agreement-link">《隐私协议》</navigator>
			  </text>
		  </view> -->
